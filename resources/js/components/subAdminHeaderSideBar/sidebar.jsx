...
// const baseNavItems = [
//   { name: 'Dashboard', href: '/subadmin/dashboard', icon: LayoutDashboard, permission: 'userDashboard' },
//   { name: 'My Profile', href: '/subadmin/profile', icon: UserCircle2, permission: 'userProfile' },
//   { name: 'My Reports', href: '/subadmin/reports', icon: FileText, permission: 'reportView' },
// ];
...
const baseNavItems = [
  { name: 'Dashboard', href: '/subadmin/dashboard', icon: LayoutDashboard, permission: 'subADashboard' },
  { name: 'My Profile', href: '/subadmin/profile', icon: UserCircle2, permission: 'subAProfile' },
  { name: 'My Reports', href: '/subadmin/reports', icon: FileText, permission: 'subAReportView' },
  // Add more ERP-specific items as needed
  { name: 'Users', href: '/subadmin/createAdmin', icon: UserCircle2, permission: 'subAManagement' },
  { name: 'Settings', href: '/subadmin/settings', icon: FileText, permission: 'subASettingsView' },
];
...
export default function SubAdminSidebar({ isOpen, toggleSidebar }) {
  ...
  const handleLogout = () => {
    // Inertia.js POST request to logout route
  ...
  return (
    ...
    >
      {/* Header with ERP Branding and Toggle */}
      <div className="flex items-center justify-between px-4 py-4 bg-teal-600 text-white">
        <h2 className="font-bold text-lg">ERP SubAdmin</h2>
        <button onClick={toggleSidebar} className="md:hidden">
          <X className="w-5 h-5" />
        </button>
      </div>
